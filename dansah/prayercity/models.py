...
class PrayerCity(models.Model):
    ...
    sub_title = models.DateTimeField("sub_title", auto_now_add=True)
    ...
    cover_image_path = models.ImageField("Cover image", upload_to=prayer_city_upload_image_path, null=True, blank=True)
